...
Ergänzend gibt es eine freiwillige [WhatsApp-Community „Rossmann Store Tracker – Hilfe & Austausch"](https://chat.whatsapp.com/ELMb90gBK1cGDPbKX3eKZ1), in der sich Nutzer gegenseitig bei Einrichtung, Betrieb, DANs und Bestandsmeldungen helfen können. Die Community ist ein optionaler, externer Drittanbieter-Dienst (WhatsApp/Meta) und gehört weder zur Projektinfrastruktur noch wird sie zentral betrieben; es gelten die Nutzungsbedingungen von WhatsApp. Sie ist kein garantierter oder offizieller Supportkanal; technische Fehler und nachvollziehbare Verbesserungsvorschläge sollen weiterhin über GitHub erfasst werden.
